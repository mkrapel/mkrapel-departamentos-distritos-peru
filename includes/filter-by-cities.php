...
if ( ! function_exists( 'mkrapel_pe_filters_by_cities_method' ) ) {
	function mkrapel_pe_filters_by_cities_method() {
		class MkRapel_PE_Filters_By_Cities_Method extends WC_Shipping_Method {
			...
			public function __construct($instance_id = 0) {
				...
				$this->method_title       	= __( 'Envío por Distrito PE');
			...
			public function showCitiesRegions() {
				...
				foreach ($zones as $zone){
					if (strpos($zone->code, ':') !== false){
						...
						$states = MkRapel_Departamentos_Distritos_PE::get_places( $place[0] );  /** Change for country **/
